...
class CanteenReport extends StatefulWidget {
  @override
  State<CanteenReport> createState() => _CanteenReportState();
}

class _CanteenReportState extends State<CanteenReport> {
  ...
  final dateController = Get.put(TimeController());
  ...
  Future<void> selectDate(BuildContext context) async {
    ...
    if (picked != null) {
      ...
      salesController.calenderDate.value =
          DateFormat('dd/MM/yyyy\'', 'en').format(picked);
      orderRequestController.fetchMeal(0, dateController.date.value);
      salesController.fetchTotalOrder();
      salesController.fetchTotalSales();
      orderholdController.fetchDailyHold('All', dateController.date.value);
    }
  }
